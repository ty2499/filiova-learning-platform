...
export default function FreelancerSignupBasic() {
  ...
  const submitMutation = useMutation({
    mutationFn: async (data: BasicSignupForm) => {
      const response = await fetch("/api/freelancer/applications/initiate", {
        method: "POST",
  ...
  const handleResendLink = async () => {
    ...
    try {
      const response = await fetch("/api/freelancer/applications/resend-link", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div className="flex items-start gap-3 text-left">
                  ...
                  <div className="text-sm text-blue-800 dark:text-blue-200">
                    ...
                    <p className="text-blue-600 dark:text-blue-300 text-xs">The link will expire in 24 hours</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <div className="flex items-start gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600 dark:text-gray-400 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
